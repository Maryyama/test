...
public class Medicament extends JFrame implements ActionListener {
    ...
    JTextField Code, libelle,indications,psologie;
...
psologie = new JTextField();

/*ajout de trois label et de trois zones de texte a panHaut*/
panHaut.add( new JLabel ("Code client")); panHaut.add (Code);
panHaut.add( new JLabel("Libellé")); panHaut.add(libelle);
panHaut.add( new JLabel("Indications")); panHaut.add(indications);
panHaut.add( new JLabel("Psologie")); panHaut.add(psologie);
...
String Indications=indications.getText ( );
String Psologie=psologie.getText ( );


 if(Code.getText ( ).equals("") || libelle.getText ( ).equals("") || indications.getText ( ).equals("") || psologie.getText ( ).equals(""))
	...
	try {con =DriverManager.getConnection ("jdbc:mysql://localhost/centre_medical","root","") ;
	  ...
	  try {
                ...
                String sql="INSERT INTO medicament (code,libelle,indications,psologie) VALUES ('"+code+"','"+Libelle+"','"+Indications+"','"+Psologie+"')";
                st.executeUpdate(sql);
                
                 JOptionPane.showMessageDialog(this,"Le médicament "+code+" a été bien ajouté");
                // Matricule.setText("") ;
                 Code.setText("") ;
                 libelle.setText("") ;
                 indications.setText("") ;
